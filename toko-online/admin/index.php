...
$pageTitle = 'Admin Login - Percetakan Rainbow';
        ...
        <div class="login-box">
            ...
            <form method="POST" class="login-form" id="loginForm" autocomplete="off">
                <div class="form-group">
                    <label for="username">
                        <i class="fas fa-user" style="color:var(--danger);"></i> Username
                    </label>
                ...
                <div class="form-group">
                    <label for="password">
                        <i class="fas fa-lock" style="color:var(--danger);"></i> Password
                    </label>
                    <div class="input-group">
            ...
            <div class="login-footer">
                ...
                <p style="font-size:12px;color:#999;margin-top:8px;">
                    &copy; <?= date('Y') ?> Percetakan Rainbow. All rights reserved.
                </p>
            </div>
        </div>
    </div>
