...
.payment-stat-card .stat-value.dp { color: var(--warning); }
.payment-stat-card .stat-value.paid { color: var(--success); }
.payment-stat-card .stat-value.unpaid { color: #95a5a6; }
.payment-stat-card .stat-value.verification { color: var(--info); }
...
<div class="admin-layout">
    ...
    <main class="admin-main">
        ...
        <!-- 🔥 🔥 STATISTIK PEMBAYARAN 🔥 🔥 -->
        <h2 style="font-size:18px;color:var(--primary);margin-bottom:15px;">💰 Status Pembayaran</h2>
            ...
            <div class="chart-bars">
                ...
                <div class="chart-bar-wrapper">
                    ...
                    <div class="chart-label">
                        ...
                        <br>
                        <small style="font-weight:bold;color:var(--primary);"><?= formatRupiah($stat['total_amount']) ?></small>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <!-- 🔥 PESANAN TERBARU -->
        <h2 style="font-size:18px;color:var(--primary);margin-bottom:15px;">📋 Pesanan Terbaru</h2>
        <table class="table">
            <thead>
                <tr>
                    <th>Kode</th>
