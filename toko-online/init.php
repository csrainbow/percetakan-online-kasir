...
if (!$isAuthorized) {
    ...
    <head>
        ...
        <title>Setup Database - Percetakan Rainbow</title>
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .login-box .logo span { color: var(--danger); }
            .login-box .subtitle {
                color: #6c757d;
                font-size: 14px;
                margin-bottom: 25px;
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .info-item .value.warning { color: var(--danger); }
        .messages {
            margin: 15px 0;
            padding: 0;
            list-style: none;
