...
if (!function_exists('cs_shorten')) {
    function cs_shorten($longUrl) {
        if (preg_match('#^https?://(www\.)?cslink\.web\.id/#i', (string)$longUrl)) {
            return $longUrl;
        }
        global $db;
        $CSLINK_KEY = '291eae854f11f5f3a53a5d39940dfe7944683ab70f23e438';
        try {
            $db->exec("CREATE TABLE IF NOT EXISTS link_cache (long_url TEXT PRIMARY KEY, short_url TEXT, created_at TEXT)");
