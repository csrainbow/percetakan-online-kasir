...
$pageTitle = 'Profil Saya - Percetakan Rainbow';
...
.profile-avatar {
    ...
    height: 80px;
    border-radius: 50%;
    background: linear-gradient(135deg, #111111, var(--danger));
    display: flex;
    align-items: center;
...
<div class="profile-container">
    ...
    <form method="POST" class="profile-form" id="profileForm">
        ...
        <div style="border-top:2px solid var(--danger);padding-top:15px;margin-top:5px;">
