...
<tr><td>Sudah Dibayar</td><td style="text-align:right;color:var(--success);"><?= formatRupiah($totalDibayar) ?></td></tr>
                <tr class="total-row">
                    <td><strong>Sisa</strong></td>
                    <td style="text-align:right;<?= $sisaAmount > 0 ? 'color:var(--danger);' : 'color:var(--success);' ?>">
